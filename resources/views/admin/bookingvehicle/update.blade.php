    ...
    <div class="col-md-6">
        <div class="text text-center">
				...
				<div class="row-3">
					...
					<form role="form" action="{{route('bookingvehicle.update',$BookingVehicle->id)}}" method="post"
							...
							<div class="box-body">
                              ...
                              @endif
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{$BookingVehicle->Driver_License}}"
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="phone"
										  value="{{$BookingVehicle->phone}}"  id="exampleInputPassword1"
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{$BookingVehicle->start_date}}"  id="exampleInputPassword1"
										   placeholder="Enter Phone">
									<span>
									</span>
                                    <span class="text-danger">
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{$BookingVehicle->end_date}}"  id="exampleInputPassword1"
