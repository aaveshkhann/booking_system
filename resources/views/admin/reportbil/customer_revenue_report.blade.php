            ...
            <li class="breadcrumb-item active">Report</li>
               ...
               <table class="table table-bordered m-5 ">
                ...
                <thead>
                  ...
                  <tr class="">
                        <th class="text-dark bg-default" scope="col">Load ID#</th>
                        <th class="text-dark bg-default" scope="col">P/L</th>
                        <th class="text-dark bg-default" scope="col">D/L</th>
                        <th class="text-dark bg-default"scope="col">Dispatch Pay</th>
                        <th class="text-dark bg-default" scope="col">	Payroll Advance</th>
