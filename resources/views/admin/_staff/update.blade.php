    ...
    <div class="col-md-6">
        <div class="text text-center">
				...
				<div class="row-3">
					...
					<form role="form" action="{{route('staffs.update',$staffs->id)}}" method="POST"
							...
							<div class="box-body">
                              ...
                              @endif
								...
								<div class="form-group">
                                    ...
                                    value="{{$staffs->first_name}}"placeholder="Enter First Name">
									<span>
									</span>
                                    <span class="text-danger">
                                        @error('first_name')
                                ...
                                <div class="form-group">
									<div class="form-group">
                                        ...
                                        <select name="Gender"    value="{{$staffs->Gender}}" class="form-control select2">
                                            <option value="Male" {{ $staffs->Gender == 'Male' ? 'selected' : '' }}>Male</option>
                                            <option value="Female" {{ $staffs->Gender == 'Female' ? 'selected' : '' }} >Female</option>
                                            <option  value="Custom" {{ $staffs->Gender == 'Custom' ? 'selected' : '' }} >Custom</option>
                                        </select>
                                        <span>
                                </span>
                                <span class="text-danger">
								...
								<div class="form-group">
                                    ...
                                    value="{{$staffs->phone}}" id="exampleInputPassword1"
